...
public class NimUIKit {
     ...
     * @param option  自定义选项
     */
    public static void init(Context context, com.netease.nim.uikit.api.UIKitOptions option) {
     ...
     * @param contactProvider  通讯录信息提供者
     */
    public static void init(Context context, com.netease.nim.uikit.api.UIKitOptions option, IUserInfoProvider userInfoProvider, ContactProvider contactProvider) {
     ...
     * @return UIKitOptions
     */
    public static com.netease.nim.uikit.api.UIKitOptions getOptions() {
