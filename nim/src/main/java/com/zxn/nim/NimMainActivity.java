...
import com.zxn.nim.common.ui.viewpager.FadeInOutPageTransformer;
import com.zxn.nim.common.ui.viewpager.PagerSlidingTabStrip;
...
import com.zxn.nim.main.activity.GlobalSearchActivity;
import com.zxn.nim.main.activity.RecentSessionActivity;
import com.zxn.nim.main.activity.SettingsActivity;
import com.zxn.nim.main.helper.CustomNotificationCache;
import com.zxn.nim.main.helper.SystemMessageUnreadManager;
import com.zxn.nim.main.reminder.ReminderItem;
import com.zxn.nim.main.reminder.ReminderManager;
import com.zxn.nim.session.SessionHelper;
import com.zxn.nim.team.TeamCreateHelper;
import com.zxn.nim.team.activity.AdvancedTeamSearchActivity;
...
public class NimMainActivity extends UI implements ViewPager.OnPageChangeListener,
    ...
    private void observerSyncDataComplete() {
        ...
        if (!syncCompleted) {
            DialogMaker.showProgressDialog(NimMainActivity.this, getString(R.string.prepare_data))
