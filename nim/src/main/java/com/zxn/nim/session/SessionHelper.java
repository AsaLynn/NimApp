...
import com.zxn.nim.contact.activity.RobotProfileActivity;
import com.zxn.nim.contact.activity.UserProfileActivity;
import com.zxn.nim.main.helper.MessageHelper;
import com.zxn.nim.session.action.AVChatAction;
import com.zxn.nim.session.action.AckMessageAction;
import com.zxn.nim.session.action.FileAction;
import com.zxn.nim.session.action.GuessAction;
import com.zxn.nim.session.action.RTSAction;
import com.zxn.nim.session.action.SnapChatAction;
import com.zxn.nim.session.action.TeamAVChatAction;
import com.zxn.nim.session.action.TipAction;
import com.zxn.nim.session.activity.AckMsgInfoActivity;
import com.zxn.nim.session.activity.MessageHistoryActivity;
import com.zxn.nim.session.activity.MessageInfoActivity;
import com.zxn.nim.session.extension.CustomAttachParser;
import com.zxn.nim.session.extension.CustomAttachment;
import com.zxn.nim.session.extension.GuessAttachment;
import com.zxn.nim.session.extension.MultiRetweetAttachment;
import com.zxn.nim.session.extension.RTSAttachment;
import com.zxn.nim.session.extension.RedPacketAttachment;
import com.zxn.nim.session.extension.RedPacketOpenedAttachment;
import com.zxn.nim.session.extension.SnapChatAttachment;
import com.zxn.nim.session.extension.StickerAttachment;
import com.zxn.nim.session.search.SearchMessageActivity;
import com.zxn.nim.session.viewholder.MsgViewHolderAVChat;
import com.zxn.nim.session.viewholder.MsgViewHolderDefCustom;
import com.zxn.nim.session.viewholder.MsgViewHolderFile;
import com.zxn.nim.session.viewholder.MsgViewHolderGuess;
import com.zxn.nim.session.viewholder.MsgViewHolderMultiRetweet;
import com.zxn.nim.session.viewholder.MsgViewHolderRTS;
import com.zxn.nim.session.viewholder.MsgViewHolderSnapChat;
import com.zxn.nim.session.viewholder.MsgViewHolderSticker;
import com.zxn.nim.session.viewholder.MsgViewHolderTip;
