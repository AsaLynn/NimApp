...
import com.nim.app.main.activity.MultiportActivity;
...
public class SessionListFragment extends MainTabFragment {
    ...
    private void findViews() {
        notifyBar = getView().findViewById(com.zxn.nim.R.id.status_notify_bar);
        notifyBarText = getView().findViewById(com.zxn.nim.R.id.status_desc_label);
        notifyBar.setVisibility(View.GONE);

        multiportBar = getView().findViewById(com.zxn.nim.R.id.multiport_notify_bar);
        ...
        public void onEvent(StatusCode code) {
            if (code.wontAutoLogin()) {
                ...
                if (code == StatusCode.NET_BROKEN) {
                    ...
                    notifyBarText.setText(com.zxn.nim.R.string.net_broken);
                } else if (code == StatusCode.UNLOGIN) {
                    notifyBar.setVisibility(View.VISIBLE);
                    notifyBarText.setText(com.zxn.nim.R.string.nim_status_unlogin);
                } else if (code == StatusCode.CONNECTING) {
                    notifyBar.setVisibility(View.VISIBLE);
                    notifyBarText.setText(com.zxn.nim.R.string.nim_status_connecting);
                } else if (code == StatusCode.LOGINING) {
                    notifyBar.setVisibility(View.VISIBLE);
                    notifyBarText.setText(com.zxn.nim.R.string.nim_status_logining);
                } else {
                    notifyBar.setVisibility(View.GONE);
                }
            }
    ...
    Observer<List<OnlineClient>> clientsObserver = new Observer<List<OnlineClient>>() {
        ...
        public void onEvent(List<OnlineClient> onlineClients) {
            ...
            if (onlineClients == null || onlineClients.size() == 0) {
                ...
                TextView status = multiportBar.findViewById(com.zxn.nim.R.id.multiport_desc_label);
                ...
                switch (client.getClientType()) {
                    ...
                    case ClientType.MAC:
                        status.setText(getString(com.zxn.nim.R.string.multiport_logging) + getString(com.zxn.nim.R.string.computer_version));
                        break;
                    case ClientType.Web:
                        status.setText(getString(com.zxn.nim.R.string.multiport_logging) + getString(com.zxn.nim.R.string.web_version));
                        break;
                    case ClientType.iOS:
                    case ClientType.Android:
                        status.setText(getString(com.zxn.nim.R.string.multiport_logging) + getString(com.zxn.nim.R.string.mobile_version));
                        break;
                    default:
                        multiportBar.setVisibility(View.GONE);
                        break;
    ...
    private void kickOut(StatusCode code) {
        ...
        if (code == StatusCode.PWD_ERROR) {
            ...
            ToastHelper.showToast(getActivity(), com.zxn.nim.R.string.login_failed);
        } else {
            LogUtil.i("Auth", "Kicked!");
        }

        if (code == StatusCode.DATA_UPGRADE) {
            onLogout(getString(com.zxn.nim.R.string.kickout_encrypt_database));
        } else {
            onLogout("");
        }
    }
    ...
    private void addRecentContactsFragment() {
        ...
        fragment.setContainerId(com.zxn.nim.R.id.messages_fragment);
