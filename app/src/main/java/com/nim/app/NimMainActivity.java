...
import com.nim.app.common.ui.viewpager.FadeInOutPageTransformer;
import com.nim.app.common.ui.viewpager.PagerSlidingTabStrip;
...
import com.nim.app.main.activity.GlobalSearchActivity;
import com.nim.app.main.activity.RecentSessionActivity;
import com.nim.app.main.activity.SettingsActivity;
import com.nim.app.main.helper.CustomNotificationCache;
import com.nim.app.main.helper.SystemMessageUnreadManager;
import com.nim.app.main.reminder.ReminderItem;
import com.nim.app.main.reminder.ReminderManager;
import com.nim.app.session.SessionHelper;
import com.nim.app.team.TeamCreateHelper;
import com.nim.app.team.activity.AdvancedTeamSearchActivity;
 ...
 */
public class NimMainActivity extends UI implements ViewPager.OnPageChangeListener,
    ...
    public static void start(Context context, Intent extras) {
        ...
        intent.setClass(context, NimMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zxn.nim.R.layout.main);
        setToolBar(com.zxn.nim.R.id.toolbar, com.zxn.nim.R.string.app_name);
        isFirstIn = true;
    ...
    private void observerSyncDataComplete() {
        ...
        if (!syncCompleted) {
            DialogMaker.showProgressDialog(NimMainActivity.this, getString(com.zxn.nim.R.string.prepare_data))
                    .setCanceledOnTouchOutside(false);
        }
    }

    private void findViews() {
        tabs = findView(com.zxn.nim.R.id.tabs);
        pager = findView(com.zxn.nim.R.id.main_tab_pager);
    }
    ...
    private void setupTabs() {
        tabs.setOnCustomTabListener(new PagerSlidingTabStrip.OnCustomTabListener() {
            ...
            public int getTabLayoutResId(int position) {
                return com.zxn.nim.R.layout.tab_layout_main;
            }
    ...
    Observer<CustomNotification> customNotificationObserver = (Observer<CustomNotification>) notification -> {
        ...
        try {
            ...
            if (obj != null && obj.getIntValue("id") == 2) {
                ...
                ToastHelper.showToast(NimMainActivity.this, tip);
            }
    ...
    private void initUnreadCover() {
        DropManager.getInstance().init(this, findView(com.zxn.nim.R.id.unread_cover), (id, explosive) -> {
    ...
    private void requestBasicPermission() {
        ...
        MPermission.with(NimMainActivity.this).setRequestCode(BASIC_PERMISSION_REQUEST_CODE)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.zxn.nim.R.menu.main_activity_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == com.zxn.nim.R.id.about) {
            startActivity(new Intent(NimMainActivity.this, SettingsActivity.class));
        } else if (itemId == com.zxn.nim.R.id.view_cloud_session) {
            RecentSessionActivity.start(this);
        } else if (itemId == com.zxn.nim.R.id.create_normal_team) {
            ContactSelectActivity.Option option = TeamHelper.getCreateContactSelectOption(null, 50);
            NimUIKit.startContactSelector(NimMainActivity.this, option, REQUEST_CODE_NORMAL);
        } else if (itemId == com.zxn.nim.R.id.create_regular_team) {
            ContactSelectActivity.Option advancedOption = TeamHelper
                    .getCreateContactSelectOption(null, 50);
            NimUIKit.startContactSelector(NimMainActivity.this, advancedOption,
                    REQUEST_CODE_ADVANCED);
        } else if (itemId == com.zxn.nim.R.id.search_advanced_team) {
            AdvancedTeamSearchActivity.start(NimMainActivity.this);
        } else if (itemId == com.zxn.nim.R.id.add_buddy) {
            //AddFriendActivity.start(NimMainActivity.this);
        } else if (itemId == com.zxn.nim.R.id.search_btn) {
            GlobalSearchActivity.start(NimMainActivity.this);
        } else if (itemId == com.zxn.nim.R.id.enter_ysf) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_NORMAL) {
            ...
            if (selected != null && !selected.isEmpty()) {
                TeamCreateHelper.createNormalTeam(NimMainActivity.this, selected, false, null);
            } else {
                ToastHelper.showToast(NimMainActivity.this, "请选择至少一个联系人！");
            }
        } else if (requestCode == REQUEST_CODE_ADVANCED) {
            final ArrayList<String> selected = data.getStringArrayListExtra(
                    ContactSelectActivity.RESULT_DATA);
            TeamCreateHelper.createAdvancedTeam(NimMainActivity.this, selected);
        }
    }
