...
import com.nim.app.DemoCache;
import com.zxn.nim.R;
import com.nim.app.contact.activity.RobotProfileActivity;
import com.nim.app.contact.activity.UserProfileActivity;
import com.nim.app.main.helper.MessageHelper;
import com.nim.app.session.action.AVChatAction;
import com.nim.app.session.action.AckMessageAction;
import com.nim.app.session.action.FileAction;
import com.nim.app.session.action.GuessAction;
import com.nim.app.session.action.RTSAction;
import com.nim.app.session.action.SnapChatAction;
import com.nim.app.session.action.TeamAVChatAction;
import com.nim.app.session.action.TipAction;
import com.nim.app.session.activity.AckMsgInfoActivity;
import com.nim.app.session.activity.MessageHistoryActivity;
import com.nim.app.session.activity.MessageInfoActivity;
import com.nim.app.session.extension.CustomAttachParser;
import com.nim.app.session.extension.CustomAttachment;
import com.nim.app.session.extension.GuessAttachment;
import com.nim.app.session.extension.MultiRetweetAttachment;
import com.nim.app.session.extension.RTSAttachment;
import com.nim.app.session.extension.RedPacketAttachment;
import com.nim.app.session.extension.RedPacketOpenedAttachment;
import com.nim.app.session.extension.SnapChatAttachment;
import com.nim.app.session.extension.StickerAttachment;
import com.nim.app.session.search.SearchMessageActivity;
import com.nim.app.session.viewholder.MsgViewHolderAVChat;
import com.nim.app.session.viewholder.MsgViewHolderDefCustom;
import com.nim.app.session.viewholder.MsgViewHolderFile;
import com.nim.app.session.viewholder.MsgViewHolderGuess;
import com.nim.app.session.viewholder.MsgViewHolderMultiRetweet;
import com.nim.app.session.viewholder.MsgViewHolderRTS;
import com.nim.app.session.viewholder.MsgViewHolderSnapChat;
import com.nim.app.session.viewholder.MsgViewHolderSticker;
import com.nim.app.session.viewholder.MsgViewHolderTip;
