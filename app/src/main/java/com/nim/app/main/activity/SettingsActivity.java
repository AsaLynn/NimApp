package com.nim.app.main.activity;
...
import com.nim.app.NimMainActivity;
import com.nim.app.contact.activity.UserProfileSettingActivity;
import com.nim.app.jsbridge.JsBridgeActivity;
import com.zxn.nim.R;
import com.nim.app.config.preference.UserPreferences;
import com.nim.app.main.adapter.SettingsAdapter;
import com.nim.app.main.model.SettingTemplate;
import com.nim.app.main.model.SettingType;
...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener, SettingsAdapter.CheckChangeListener {
    ...
    private void initItems() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            items.add(new SettingTemplate(TAG_NRTC_SETTINGS, "网络通话设置"));
            items.add(SettingTemplate.addLine());
     ...
     */
    private void logout() {
        NimMainActivity.logout(SettingsActivity.this, false);
        finish();
