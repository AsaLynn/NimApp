...
public class NimUIKit {
     ...
     * @param option  自定义选项
     */
    public static void init(Context context, com.zxn.netease.nimsdk.api.UIKitOptions option) {
     ...
     * @param contactProvider  通讯录信息提供者
     */
    public static void init(Context context, com.zxn.netease.nimsdk.api.UIKitOptions option, IUserInfoProvider userInfoProvider, ContactProvider contactProvider) {
     ...
     * @return UIKitOptions
     */
    public static com.zxn.netease.nimsdk.api.UIKitOptions getOptions() {
