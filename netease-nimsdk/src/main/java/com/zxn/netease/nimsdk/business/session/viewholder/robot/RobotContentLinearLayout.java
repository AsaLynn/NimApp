...
import com.zxn.netease.nimsdk.business.robot.model.RobotBotContent;
import com.zxn.netease.nimsdk.business.robot.model.RobotResponseContent;
import com.zxn.netease.nimsdk.business.robot.parser.elements.base.Element;
...
import com.zxn.netease.nimsdk.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.zxn.netease.nimsdk.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.zxn.netease.nimsdk.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
