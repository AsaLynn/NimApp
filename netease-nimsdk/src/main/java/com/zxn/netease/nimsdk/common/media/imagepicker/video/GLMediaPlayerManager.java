package com.zxn.netease.nimsdk.common.media.imagepicker.video;
...
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_ERROR;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_IDLE;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_INIT;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_INITIALIZED;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_PAUSED;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_PENDING_DESTROY;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_PLAYBACK_COMPLETE;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_PREPARED;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_PREPARING;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_SEEKING;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_STARTED;
import static com.zxn.netease.nimsdk.common.media.imagepicker.video.GLMediaPlayer.PlayerState.PLAYER_STOPPED;
