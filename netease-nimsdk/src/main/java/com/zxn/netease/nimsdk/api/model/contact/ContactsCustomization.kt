...
interface ContactsCustomization {
     ...
     */
    fun onGetFuncViewHolderClass(): Class<out AbsContactViewHolder<out AbsContactItem?>?>?
     ...
     * @return 功能项集合
     */
    fun onGetFuncItems(): List<AbsContactItem?>?
     ...
     */
    fun onFuncItemClick(item: AbsContactItem?)
}