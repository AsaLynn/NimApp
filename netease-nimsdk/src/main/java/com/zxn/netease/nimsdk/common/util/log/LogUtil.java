package com.zxn.netease.nimsdk.common.util.log;


import com.zxn.netease.nimsdk.common.util.log.sdk.LogBase;
import com.zxn.netease.nimsdk.common.util.log.sdk.wrapper.NimLog;
import com.zxn.netease.nimsdk.common.util.storage.ExternalStorage;
...
public class LogUtil extends NimLog {
    ...
    public static void init(String logDir, int level) {
        ...
        initDateNLog(null, logDir, LOG_FILE_NAME_PREFIX, level, 0, 0, true, interceptor);
    }
